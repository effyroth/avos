...
public class AVAnalytics
{
  ...
  static void reportError(Context context, Map<String, Object> crashData, SaveCallback callback)
  {
    ...
    PaasClient.statistisInstance().postObject("stats/crash", jsonString, false, true, new GenericObjectCallback()
    {
      ...
      public void onFailure(Throwable error, String content)
      {
        ...
        if (this.val$callback != null)
          this.val$callback.done(AVErrorUtils.createException(error, content));
      }
    }
